...
- 照片：本地 `/assets/hero-returns.jpg`，户外网球动作（2026-08-26 Imagine）。Park：要活力参考 Baleaf；人物必须是**欧美人**（金发），不要亚洲面孔。白网球 polo + 裙，挥拍；着装覆盖躯干，**不要**运动内衣。裁切 `object-position: 68% 36%`（人在右、脸中上）。左缘球场留给浮卡，不要挡脸。
