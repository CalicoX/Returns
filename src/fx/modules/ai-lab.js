...
(function () {
  ...
  (function intro() {
    ...
    function wantIn(r, vh) {
      ...
      if (isIntroFullyDocked() && ratio > 0.12) return true;
      if (isIn) {
    ...
    function syncPillMorphFromTrack() {
      ...
      if (morph < 0.02) {
        ...
        /* reverse complete → title/orb must be back */
    ...
    var CASES = [
      {
        ...
        theme: "theme-ogl",
        hero: "https://images.unsplash.com/photo-1516914589923-f105f1535f88?auto=format&fit=crop&w=1400&q=80",
        heroAlt: "OGL winter campaign",
        trackTitle: "Track Your Order",
        statusH: "Your Order is Almost Home",
        statusSub: "Package is out for delivery — estimated arrival today by 8:00 PM.",
        order: "#OGL-28491",
        ...
        timeline: [
          { cls: "done", t: "Order confirmed", s: "Mon · Mar 12 · 10:24 AM", loc: "OGL Studio · New York, NY" },
        ...
        favH: "Your New Favorites Are On The Way",
        favP: "Complete the look while you wait — curated for your order.",
        favs: [
        ...
        why: [
          { h: "Why OGL", p: "Thoughtful materials, timeless cuts, and packaging made to feel like a gift — every shipment." },
          { h: "Our Story", p: "Designed for slow mornings and cold evenings. We ship with care so the unboxing matches the brand." },
        ],
        footer: "Modern essentials for everyday ritual.",
        shop: ["New arrivals", "Outerwear", "Knitwear"],
      },
      {
        layout: "split",
        logo: "LUMÉ",
        nav: ["Skincare", "Rituals"],
        theme: "theme-lume",
        hero: "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=1400&q=80",
        heroAlt: "LUMÉ spa ritual",
        trackTitle: "Track your ritual",
        statusH: "Your set is on its way",
        statusSub: "Label created — carrier accepted the package this morning.",
        order: "#LUME-11028",
        ...
        timeline: [
          { cls: "done", t: "Order confirmed", s: "Wed · Apr 2 · 09:12 AM", loc: "Payment captured · LUMÉ checkout" },
          { cls: "done", t: "Quality checked & packed", s: "Wed · Apr 2 · 02:40 PM", loc: "LUMÉ Lab · Portland, OR" },
        ...
        favH: "Pair with your order",
        favP: "Derm-tested essentials customers reorder every season.",
        favs: [
        ...
        why: [
          { h: "Clean formulas", p: "Transparent ingredients, refillable jars, and cold-chain aware packaging for actives." },
          { h: "Proactive care", p: "SMS when temperature-sensitive SKUs leave the warehouse — no mystery delays." },
        ],
        footer: "Clinical calm for everyday skin.",
        shop: ["Serums", "Masks", "SPF"],
      },
      {
        layout: "steps",
        logo: "NOVA",
        nav: ["Audio", "Accessories"],
        theme: "theme-nova",
        hero: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=1400&q=80",
        heroAlt: "NOVA headphones campaign",
        trackTitle: "Track shipment",
        statusH: "In transit to your city",
        statusSub: "Arrived at regional hub — next scan expected within 6 hours.",
        order: "#NOVA-77204",
        ...
        timeline: [
          { cls: "done", t: "Order confirmed", s: "Thu · May 1 · 11:05 AM", loc: "NOVA store · Checkout complete" },
        ...
        favH: "Upgrade the setup",
        favP: "Accessories that ship free with your tracking visit.",
        favs: [
        ...
        why: [
          { h: "Engineered quiet", p: "Studio-tuned ANC and packaging that survives cross-border without drama." },
          { h: "Live milestones", p: "Every scan pushes to your branded page — no carrier-site detour." },
        ],
        footer: "Sound without compromise.",
        shop: ["Headphones", "Cases", "Cables"],
      },
      {
        layout: "stack",
        logo: "TRAIL",
        nav: ["Gear", "Routes"],
        theme: "theme-trail",
        hero: "https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=1400&q=80",
        heroAlt: "TRAIL outdoor adventure",
        trackTitle: "Track your kit",
        statusH: "Delivered — enjoy the trail",
        statusSub: "Signed for at front desk · May 18, 3:41 PM.",
        order: "#TRAIL-90412",
        ...
        timeline: [
          { cls: "done", t: "Order confirmed", s: "Wed · May 14 · 08:00 AM", loc: "TRAIL warehouse · Boulder, CO" },
        ...
        favH: "Plan the next outing",
        favP: "Trail-ready add-ons recommended from this shipment.",
        favs: [
        ...
        why: [
          { h: "Built for weather", p: "Tested on switchbacks; shipping updates that respect remote drop-offs." },
          { h: "Brand-owned track", p: "Customers stay on TRAIL.com — not a generic carrier page." },
        ],
        footer: "Gear that earns its miles.",
        shop: ["Footwear", "Packs", "Lights"],
      },
    ];
