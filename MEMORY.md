...
- 照片：本地 `/assets/hero-returns.jpg`，户外网球动作棚外拍（2026-08-26 Imagine；Park：前一版高领坐姿没活力，参考 Baleaf 客户图的运动感）。白网球 polo + 裙，挥拍看球；着装覆盖躯干，**不要**运动内衣。裁切 `object-position: 68% 36%`（人在右、脸中上）。左缘球场留给浮卡，不要挡脸。
