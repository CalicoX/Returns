...
BrandsSay：紧跟 TrustBand，**白底**（标题/副标题深色）。卡片仍是照片+白字跑马灯。不要深色底、不要放回 ExploreMore 后面。
...
- 左文案 / 右插图；人物卡约 620px、靠右。照片是户外网球动作（`/assets/hero-returns.jpg`），参考 Baleaf 运动感；不要坐姿棚拍、不要运动内衣。
